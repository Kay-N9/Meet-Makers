 ...
 */
class getChoicePRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChoicePRepository' shared autowired service.
     *
     * @return \App\Repository\ChoicePRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChoicePRepository.php';

        return $container->privates['App\\Repository\\ChoicePRepository'] = new \App\Repository\ChoicePRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
