 ...
 */
class getReseauxRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReseauxRepository' shared autowired service.
     *
     * @return \App\Repository\ReseauxRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReseauxRepository.php';

        return $container->privates['App\\Repository\\ReseauxRepository'] = new \App\Repository\ReseauxRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
