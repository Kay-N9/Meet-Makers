 ...
 */
class getLogAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\LogAuthenticator' shared autowired service.
     *
     * @return \App\Security\LogAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'LogAuthenticator.php';

        return $container->privates['App\\Security\\LogAuthenticator'] = new \App\Security\LogAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
