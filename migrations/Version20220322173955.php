 ...
 */
final class Version20220322173955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE budget budget DOUBLE PRECISION DEFAULT NULL, CHANGE upload_project upload_project VARCHAR(255) DEFAULT NULL, CHANGE upload_picture upload_picture VARCHAR(255) DEFAULT NULL');
    }
