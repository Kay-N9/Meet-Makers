 ...
 */
class getTypeDeServicesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeDeServicesRepository' shared autowired service.
     *
     * @return \App\Repository\TypeDeServicesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeDeServicesRepository.php';

        return $container->privates['App\\Repository\\TypeDeServicesRepository'] = new \App\Repository\TypeDeServicesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
